"""Concurrent file transfer sessions dashboard view."""

from __future__ import annotations

import streamlit as st

from ui.components.widgets.concurrent_file_transfer import widget as concurrent_file_transfer_widget
...
def render() -> None:
    """Render the concurrent file transfer sessions dashboard view."""
    cooldown_key = "dashboard_concurrent_file_transfer_refresh_last_click"

    if st.button("Refresh", key="dashboard_concurrent_file_transfer_refresh"):
    ...
    with refresh_col:
        auto_refresh_enabled = st.checkbox(
            ...
            value=False,
            key="dashboard_concurrent_file_transfer_auto_refresh_enabled",
        )

    render_realtime_widget(
        lambda: concurrent_file_transfer_widget.render(concurrent_users_data.fetch_data),
