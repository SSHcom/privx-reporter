"""Concurrent client connection methods dashboard view."""

from __future__ import annotations

import streamlit as st

from ui.components.widgets.concurrent_client_methods import widget as concurrent_client_methods_widget
...
def render() -> None:
    """Render concurrent client connection methods dashboard view."""
    cooldown_key = "dashboard_concurrent_client_methods_refresh_last_click"

    if st.button("Refresh", key="dashboard_concurrent_client_methods_refresh"):
    ...
    with refresh_col:
        auto_refresh_enabled = st.checkbox(
            ...
            value=False,
            key="dashboard_concurrent_client_methods_auto_refresh_enabled",
        )

    render_realtime_widget(
        lambda: concurrent_client_methods_widget.render(concurrent_users_data.fetch_data),
