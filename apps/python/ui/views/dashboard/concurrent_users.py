"""Concurrent users dashboard view."""
...
from ui.components.widgets.concurrent_users import widget as concurrent_users_widget
...
def render() -> None:
    """Render the concurrent users dashboard view."""
    cooldown_key = "dashboard_concurrent_users_refresh_last_click"

    if st.button("Refresh", key="dashboard_concurrent_users_refresh"):
    ...
    with refresh_col:
        auto_refresh_enabled = st.checkbox(
            ...
            value=False,
            key="dashboard_concurrent_users_auto_refresh_enabled",
        )

    render_realtime_widget(
        lambda: concurrent_users_widget.render(concurrent_users_data.fetch_data),
